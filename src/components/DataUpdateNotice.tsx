...
export function DataUpdateNotice({ dailyFields, monthlyFields }: DataUpdateNoticeProps) {
  return (
    <div className="mb-4 flex items-start gap-3 rounded-lg border border-blue-100 bg-blue-50 px-4 py-3 text-[13px] leading-6 text-blue-900 shadow-sm">
      ...
      <div>
        ...
        <span>
          {dailyFields} 每天 19:00 自动更新；{monthlyFields}
          每月最后一天 19:00 更新至上月数据；点击“手动更新数据”后，将立即更新所选时间范围内的数据。
        </span>
      </div>
    </div>
  );
