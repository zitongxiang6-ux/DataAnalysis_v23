...
const kpis = [
  { label: '本周开单总额', value: '¥2,856万', change: '12.5% 环比上周', trend: 'up', color: 'border-t-blue-600' },
      ...
      <div className="mx-auto max-w-[1280px] space-y-6">
        ...
        <Card>
          ...
          <div className="px-6 pt-4 text-[14px] leading-8 text-slate-700">
            ...
            <p className="mt-3 indent-8">
              从人员与客户看，张伟本周开单
              <span className="font-semibold text-primary"> ¥386万</span>，为业务员侧头部贡献；李娜保持第二梯队贡献，王强虽进入 TOP3 但环比有所回落。客户侧，深圳华强科技、上海新联电子、新加坡 AsiaTech 继续贡献主要开单，其中深圳华强科技金额最高，但也带来最大的未结订单风险。
            </p>
            <p className="mt-3 indent-8">
              从风险侧看，本周未结束订单金额
            ...
            <div className="mt-3 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-[13px] leading-7 text-amber-800">
              <strong>重点关注：</strong>本周建议优先跟进深圳华强科技 HT-202605001 号订单，同步复盘王强负责客户的交付节点；对周目标未达成的部门，按业务员和客户两条线拆分缺口，推动下周初快速补单和开单。
            </div>
          </div>

          <div className="grid grid-cols-1 gap-6 px-6 pb-4 pt-5 lg:grid-cols-2">
            <div>
              <h3 className="mb-3 text-[14px] font-semibold text-slate-700">各部门开单占比</h3>
              <div className="h-[260px]">
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    <Tooltip formatter={(value) => [formatTooltipAmount(value), '开单额']} />
              ...
              <p className="mt-3 rounded-lg bg-slate-50 px-3 py-2 text-[12px] leading-6 text-slate-600">
                小结：国内大客户部贡献 ¥1,026万，占比最高；全球渠道部与国际酒店部贡献接近，三个核心部门共同支撑本周主要开单。
              </p>
            </div>
            <div>
              <h3 className="mb-3 text-[14px] font-semibold text-slate-700">本周（周一到周日）开单趋势</h3>
              <div className="h-[260px]">
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={trendData}>
                    ...
                    <Tooltip formatter={(value, name) => [formatTooltipAmount(value), name === 'daily' ? '日开单额' : '累计开单额']} />
                    <Legend formatter={(value) => (value === 'daily' ? '日开单额' : '累计开单额')} />
              ...
              <p className="mt-3 rounded-lg bg-slate-50 px-3 py-2 text-[12px] leading-6 text-slate-600">
                小结：周四形成本周单日高点，之后日开单额略有回落，但累计曲线持续上行，说明整体交付节奏稳定。
              </p>
            </div>
          </div>

          <div className="grid grid-cols-1 gap-6 px-6 pb-6 lg:grid-cols-2">
            <ReportTable title="业务员开单 TOP3" tag={<Tag>本周</Tag>}>
              <thead>
                <tr><th>排名</th><th>业务员姓名</th><th>所属事业部</th><th className="text-right">开单额</th><th className="text-right">环比</th></tr>
              </thead>
              <tbody>
            ...
            <ReportTable title="客户开单 TOP3" tag={<Tag tone="green">本周</Tag>}>
              <thead>
                <tr><th>排名</th><th>客户名称</th><th>客户类型</th><th className="text-right">开单额</th><th className="text-right">未结订单</th></tr>
              </thead>
              <tbody>
